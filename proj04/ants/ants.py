...
class Ant(Insect):
    ...
    def can_contain(self, other):
        # BEGIN Problem 11
        if (self.container and other.container):
            return False
        elif self.container:
            if (not self.ant):
                return True
...
# END Problem 13
    ...
    def __init__(self):
        ...
        self.firstTurn = True
        self.braveAnts = []
        if QueenAnt.thereIsOne:
            self.dead = True
        else:
            self.dead = False
        QueenAnt.thereIsOne = True
    ...
    def action(self, colony):
        ...
        if self.dead:
            ...
            #begin doubling damage
            currentPosition = self.place.exit
            while not (currentPosition == None):
                if currentPosition.ant:
                    if isinstance(currentPosition.ant,BodyguardAnt) and currentPosition.ant.ant and (not (currentPosition.ant.ant in self.braveAnts)):
                        currentPosition.ant.ant.damage *= 2
                        self.braveAnts.append(currentPosition.ant.ant)
                    elif isinstance(currentPosition.ant,TankAnt) and (currentPosition.ant in self.braveAnts):
                        currentPosition.ant.damage *= 2
                        self.braveAnts.append(currentPosition.ant)
                        if currentPosition.ant.ant and currentPosition.ant.ant in self.braveAnts:
                            currentPosition.ant.ant.damage *= 2
                            self.braveAnts.append(currentPosition.ant.ant)
                    elif not (currentPosition.ant in self.braveAnts): 
                        currentPosition.ant.damage *= 2
                        self.braveAnts.append(currentPosition.ant)
    ...
    def reduce_armor(self, amount):
        ...
        # BEGIN Problem 13
        self.armor -= amount
        if (self.armor == 0) and not (self.dead):
            bees_win()
        # END Problem 13
